        ...
        <div class="metrics-grid" :class="{ expanded: isExpanded }">
            ...
            <div class="metrics-row primary">
                <div class="metric-item inference">
                    ...
                    <div class="metric-trend">
                        <span class="trend-icon">{{ getInferenceTrend() }}</span>
                    </div>
                </div>
                ...
                <div class="metric-item algorithm">
                    ...
                    <div class="metric-trend">
                        <span class="trend-icon">{{ getAlgorithmTrend() }}</span>
                    </div>
                </div>
                ...
                <div class="metric-item total">
                    ...
                    <div class="metric-trend">
                        <span class="trend-icon">{{ getTotalLatencyTrend() }}</span>
                    </div>
                </div>
            </div>
            ...
            <div v-show="isExpanded" class="charts-row">
                <div class="chart-container">
                    ...
                    <canvas ref="inferenceChart" class="performance-chart" width="200" height="60"></canvas>
                </div>

                <div class="chart-container">
                    <div class="chart-title">延迟分布</div>
                    <canvas ref="latencyChart" class="performance-chart" width="200" height="60"></canvas>
                </div>
            </div>
...
const getInferenceTrend = () => getTrend(inferenceHistory.value, props.inferenceTime)
const getAlgorithmTrend = () => getTrend(algorithmHistory.value, props.algorithmLatency)
const getTotalLatencyTrend = () => getTrend(totalLatencyHistory.value, props.totalLatency)
...
watch(() => props.inferenceTime, (newValue) => {
...
watch(() => props.algorithmLatency, (newValue) => {
    if (newValue > 0 && props.isStreaming) {
...
watch(() => props.totalLatency, (newValue) => {
    if (newValue > 0 && props.isStreaming) {
...
.metric-value.good { color: #FF9800; }
.metric-value.fair { color: #FF5722; }
